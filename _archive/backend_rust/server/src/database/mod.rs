...
crate::implement_basic_query_traits!(models::HemaBout, models::HemaBoutInsert, hema_bouts, i32, start_time.asc());
crate::implement_basic_query_traits!(models::HemaMove, models::HemaMoveInsert, hema_moves, i32, id.asc());
...
crate::implement_update_traits!(models::HemaBout, hema_bouts, i32);
crate::implement_update_traits!(models::HemaMove, hema_moves, i32);
...
crate::implement_query_by_media_file_traits!(models::HemaBout, hema_bouts, video_hash, start_time.asc());

impl models::HemaBout {
    pub fn get_by_participant(conn: &mut PooledConnection, pid: &str) -> DBResult<Vec<Self>> {
        use schema::hema_bouts::dsl::*;
        to_db_res(retry_if_db_locked!({
            hema_bouts.filter(participant_a_id.eq(pid).or(participant_b_id.eq(pid))).load::<Self>(conn)
        }))
    }
}

// HemaMediaParticipant removed
