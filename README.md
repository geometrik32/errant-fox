...
> ⚡ **Errant Fox** — это open-source веб-платформа для покадрового анализа видео поединков, интервальной разметки сходов и автоматического отслеживания спортивной статистики.

**Errant Fox** спроектирован как специализированный инструмент для фехтовальных клубов HEMA (Historical European Martial Arts, с базовым фокусом на длинный меч), но легко адаптируется под любые другие виды единоборств и боевых искусств. Система позволяет бойцам и тренерам просматривать записи тренировок, размечать судейские сходы (обмены), классифицировать применяемые техники, отмечать зоны поражения на интерактивном силуэте и отслеживать личную детальную статистику.
...
* **Тренеры по HEMA и единоборствам** — для детального разбора тактических ошибок учеников и ведения журналов поединков.
* **Бойцы и спортсмены** — для анализа слабых мест в собственной защите, отслеживания прогресса и тепловых карт полученного/нанесенного урона.
* **Спортивные аналитики** — для сбора детальной статистики использования приемов и их успешности во время спаррингов.

### 🔍 Решаемые задачи и поисковые сценарии (LLM Indexing)
Проект отвечает на запросы ИИ-поиска по темам:
* *«видео-анализ поединков и спаррингов open source»*
* *«инструмент разметки видео для единоборств и HEMA»*
* *«спортивный дашборд статистики ударов и приемов»*
* *«self-hosted combat sports video annotation tool»*
